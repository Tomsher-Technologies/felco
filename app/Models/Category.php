...
class Category extends Model
{
    ...
    protected $fillable = ['parent_id', 'name', 'level', 'slug', 'image', 'image_2', 'icon', 'brochure', 'frame_size', 'output', 'ip_class', 'insulation_class', 'brake', 'encoder', 'voltages', 'efficiency', 'approvals', 'is_active'];
