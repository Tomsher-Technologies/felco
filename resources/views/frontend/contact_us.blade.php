                 ...
                 <div>
                     <form action="{{ route('contact.submit') }}" method="post" class="space-y-6 bg-white border p-8">
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                             ...
                             <div>
                                 <input type="tel" name="phone" placeholder="{{ trans('messages.phone') }}" class="form-input w-full focus:ring-2 focus:ring-[#f06425] hover:border-[#f06425]" value="{{ old('phone') }}">
...
<div class="text-right">
    ...
    <div class="space-y-8">
        ...
        <div class="flex items-start space-x-5">
            <div class="flex-shrink-0 bg-[#f06425] p-4 rounded-full">
                <img src="{{ asset('assets/images/icons/location.svg') }}" alt="Location" class="w-6 h-6">
            </div>
            <div>
        ...
        <div class="flex items-start space-x-5">
            ...
            <div>
                ...
                <a href="tel:{{ $page->getTranslation('heading3', $lang) }}" class="text-lg text-white pt-1 inline-block hover:text-[#f06425] transition-colors duration-300">{{ $page->getTranslation('heading3', $lang) }}</a>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-5">
            ...
            <div>
                ...
                <a href="mailto:{{ $page->getTranslation('heading4', $lang) }}" class="text-lg text-white pt-1 inline-block hover:text-[#f06425] transition-colors duration-300">{{ $page->getTranslation('heading4', $lang) }}</a>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="flex space-x-6">
            <a href="{{ get_setting('facebook_link') }}" target="_blank" class="transform hover:scale-110 transition-transform duration-300" title="Facebook">
                <img src="{{ asset('assets/images/icons/facebook.svg') }}" alt="Facebook" class="w-7 h-7">
            </a>
            <a href="{{ get_setting('instagram_link') }}" target="_blank" class="transform hover:scale-110 transition-transform duration-300" title="Instagram">
                <img src="{{ asset('assets/images/icons/instagram.svg') }}" alt="Instagram" class="w-7 h-7">
            </a>
            <a href="{{ get_setting('linkedin_link') }}" target="_blank" class="transform hover:scale-110 transition-transform duration-300" title="LinkedIn">
                <img src="{{ asset('assets/images/icons/linkedin.svg') }}" alt="LinkedIn" class="w-7 h-7">
            </a>
        </div>
    </div>
</div>
