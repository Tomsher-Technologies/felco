        ...
        <x-container>
            <div class="text-center mb-16" id="section-heading">
                ...
                <p class="mx-auto mt-4 max-w-3xl text-lg text-gray-600" id="desc">
                    We've built our reputation on a foundation of four key promises. This is how we deliver excellence,
                    every time.
                </p>
            </div>
            ...
            <div class="relative" id="section-content">
                <div
                    class="hidden lg:block absolute top-2 bottom-1 left-1/2 w-1 -translate-x-1/2 rounded-full bg-primary/10">
                </div>
                ...
                <div class="grid grid-cols-1 gap-x-12 gap-y-16 lg:grid-cols-2">
                    ...
                    <div class="flex justify-start lg:justify-end" id="step1">
                        <div class="relative w-full lg:w-10/12 lg:text-right">
                            ...
                            <div
                                class="relative z-10 border-l-4 border-primary bg-white p-6 shadow-lg lg:border-l-0 lg:border-r-4">
                                <div>
                                    <h3 class="text-xl font-normal text-gray-900">2-Year Warranty</h3>
                                    <p class="mt-1 text-gray-600">Peace of mind is built-in with our comprehensive parts and
                                        labor coverage.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative w-full lg:w-10/12">
                            ...
                            <div class="relative z-10 border-l-4 border-primary bg-white p-6 shadow-lg">
                                <div>
                                    ...
                                    <p class="mt-1 text-gray-600">Expert help comes to you, ensuring fast and hassle-free
                                        resolutions.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative w-full lg:w-10/12 lg:text-right">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-gray-600">Crafted from the finest materials for superior durability
                                        and elegance.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative w-full lg:w-10/12">
                            ...
                            <div class="relative z-10 border-l-4 border-primary bg-white p-6 shadow-lg">
                                <div>
                                    ...
                                    <p class="mt-1 text-gray-600">Our professional team handles setup at no extra cost,
                                        perfected for your space.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="bg-[#e8edf1] pt-[100px] pb-[100px] relative z-10">
        <x-container>
            ...
            <div class="flex flex-col md:flex-row items-start justify-between gap-6 mb-4">
                <div class="">
                    <span class="text-orange-400 max-w-3xl text-sm uppercase tracking-wider font-semibold block mb-4">
                ...
                <div>
                    <x-button href="/contact" text="Schedule a call" class="px-6 py-3 font-medium text-sm shadow text-nowrap">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    @foreach (range(2, 5) as $i)
                        <div class="relative group bg-white p-6 shadow hover:shadow-md transition  overflow-hidden">
                            ...
                            <div
                                class="absolute inset-0 bg-[#0a8268] z-0 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-in-out">
                            </div>

                            <!-- Card Content -->
                            <div class="relative z-10 transition duration-500 group-hover:text-white">
                                <div
                                    class="text-[3rem] group-hover:text-[1.5rem] font-thin text-orange-500 group-hover:text-white mb-4 leading-none transition-all duration-500 ease-in-out">
                                    0{{ $i - 1 }}
                                </div>
                    ...
                    <x-container>
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="space-y-4" id="accordionExample">
                                @php
                                    $faqs = \App\Models\Faq::where('type', 'about_us')
                                        ->where('lang', $lang)
