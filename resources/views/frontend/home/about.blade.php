    ...
    <x-container>
        ...
        <div class="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            <div class="wow animate__animated animate__fadeInRight">
                ...
                <a href="{{ route('about_us') }}" id="about-us-button"
                   class="relative inline-flex items-center justify-center gap-2 px-6 py-3 border border-[#0a8268] text-[#0a8268] font-semibold text-sm transition-colors duration-300 shadow-lg group overflow-hidden">
