<footer class="bg-[#707777] text-[#ededed] py-12">
    <x-container>
        {{-- CTA/Newsletter Section --}}
        <div class="flex flex-col lg:flex-row justify-between items-start gap-10 mb-12 border-b border-[#505757] pb-12">
            {{-- CTA/Contact --}}
            ...
            <div class="flex-1 min-w-[220px] space-y-4">
                ...
                <p class="text-sm text-[#cccccc]">Join our newsletter for product news and exclusive offers.</p>
                <form id="newsletterForm" class="flex flex-col sm:flex-row items-center gap-2">
                    <input 
                        type="email" 
                        name="email" 
                        placeholder="Your email address"
                        class="w-full sm:w-auto flex-1 px-4 py-2 bg-[#5a6161] border border-[#808787] placeholder-[#b0b7b7] text-[#ededed] outline-none focus:border-[#f06425] focus:ring-1 focus:ring-[#f06425] transition"
                        required
                    />
                    <button type="submit"
        ...
        <div class="flex items-center justify-center my-8">
            <span class="block w-10 h-0.5 bg-[#505757]"></span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
                ...
                <p class="text-sm text-[#cccccc] mb-3">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('products') }}" class="text-[#cccccc] hover:text-[#f06425] transition">Products</a></li>
                    <li><a href="{{ route('industries') }}" class="text-[#cccccc] hover:text-[#f06425] transition">Industries</a></li>
                    <li><a href="{{ route('about_us') }}" class="text-[#cccccc] hover:text-[#f06425] transition">About Us</a></li>
                    <li><a href="{{ route('contact') }}" class="text-[#cccccc] hover:text-[#f06425] transition">Contact</a></li>
                </ul>
            </div>
            {{-- Useful Links --}}
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('faq') }}" class="text-[#cccccc] hover:text-[#f06425] transition">FAQ</a></li>
                    <li><a href="{{ route('privacy') }}" class="text-[#cccccc] hover:text-[#f06425] transition">Privacy Policy</a></li>
                    <li><a href="{{ route('terms') }}" class="text-[#cccccc] hover:text-[#f06425] transition">Terms &amp; Conditions</a></li>
                    <li><a href="{{ route('products.category', ['category_slug' => 'explore']) }}" class="text-[#cccccc] hover:text-[#f06425] transition">Explore Products</a></li>
                </ul>
            </div>
            {{-- Contact Info --}}
            <div>
                ...
                <ul class="space-y-2 text-sm text-[#cccccc]">
                    ...
                    <li>
                        Phone:
                        <a href="tel:+97148123456" class="text-[#cccccc] hover:text-[#f06425] transition">+971 4 812 3456</a>
                    </li>
                    <li>
                        Email:
                        <a href="mailto:info@felcomotors.com" class="text-[#cccccc] hover:text-[#f06425] transition">info@felcomotors.com</a>
                    </li>
                </ul>
              <div class="flex gap-4 mt-4 text-[#ededed]">
                  {{-- Facebook --}}
                  <a href="https://facebook.com" aria-label="Facebook" target="_blank" rel="noopener" class="hover:text-[#f06425] transition">
        ...
        {{-- Footer Bottom --}}
        <div class="border-t border-[#505757] pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-[#cccccc]">
            <div>
                &copy; {{ date('Y') }} Felco Motors. Dubai, UAE. All rights reserved.
            </div>
            <div class="flex gap-3 mt-2 sm:mt-0">
                <a href="{{ route('terms') }}" class="text-[#cccccc] hover:text-[#f06425]  transition">Terms &amp; Conditions</a>
                <span>&middot;</span>
                <a href="{{ route('privacy') }}" class="text-[#cccccc] hover:text-[#f06425] transition">Privacy Policy</a>
                <span>&middot;</span>
                <a href="https://www.tomsher.com/" target="_blank" rel="noopener" class="text-[#cccccc] hover:text-[#f06425] no-underline transition">Website by Tomsher</a>
            </div>
        </div>
    </x-container>
</footer>