        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 d-flex">Create Certificate Section File</h5>
                    <span>{{ $section->title }}</span>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('certificate-files.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Enter..." value="{{ old('title') }}" id="title"
                                    ...
                                    <input type="hidden" name="certificate_section_id"  id="certificate_section_id" value="{{$section->id}}">
                                @error('title')
