    ...
    <div class="card">
        ...
        <form class="p-4 repeater" action="{{ route('custom-pages.update', $page->id) }}" method="POST"
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">Image</label>
                    <div class="col-sm-10">
                ...
                <div data-repeater-list="faq">
                    <div data-repeater-item >
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="question">Question<span
                                class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="answer">Answer <span
                                class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                                <textarea class="form-control" placeholder="Answer" name="answer"></textarea>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="sort_order">Sort Order <span
                                class="text-danger">*</span> </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Sort Order" name="sort_order" value="0">
                            </div>
                        </div>
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="resize-off form-control" placeholder="Keywords" name="keywords">{!! $page->keywords !!}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="resize-off form-control" placeholder="OG Description" name="og_description">{!! $page->og_description !!}</textarea>
                    </div>
                </div>
