                    ...
                    @foreach (\App\Models\Language::all() as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                                href="{{ route('custom-pages.edit', ['id' => $page->type, 'lang' => $language->code]) }}">
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" @if ($lang == 'ae') dir="rtl" @endif
                                    class="form-control" placeholder="{{ trans('messages.heading') }}" name="heading6"
                                    value="{{ old('heading6', $page->getTranslation('heading6', $lang)) }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">Sub {{ trans('messages.heading') }}
                                <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" @if ($lang == 'ae') dir="rtl" @endif
                                    class="form-control" placeholder="{{ trans('messages.heading') }}" name="heading7"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label"
                                for="name">{{ trans('messages.description') }}</label>
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content5"
                                    rows="10">{!! $page->getTranslation('content5', $lang) !!}</textarea>
                            </div>
                        </div>
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="{{ trans('messages.heading') }}"
                                    name="heading1" @if ($lang == 'ae') dir="rtl" @endif
                        ...
                        <div class="form-group @if ($lang != 'en') d-none @endif">
                            ...
                            <div class="new_collection-categories-target">
                                <input type="hidden" name="types[]" value="product_categories">
                                <input type="hidden" name="page_type" value="product_categories">
                                <input type="hidden" name="page_id" value="{{ $page_id }}">
                                <input type="hidden" name="lang" value="{{ $lang }}">

                                @if (get_setting('product_categories') != null && get_setting('product_categories') != 'null')
                                    @foreach (json_decode(get_setting('product_categories'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker"
                                                        name="product_categories[]" data-live-search="true"
                            ...
                            <button type="button" class="btn btn-soft-secondary btn-sm" data-toggle="add-more"
								...
								<div class="col">
									<div class="form-group">
										<select class="form-control aiz-selectpicker" name="product_categories[]" data-live-search="true" required>
                                            <option value="">Select Category</option>
...
@endforeach
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">Main {{ trans('messages.heading') }}
                                <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" @if ($lang == 'ae') dir="rtl" @endif
                                    class="form-control" placeholder="{{ trans('messages.heading') }}" name="heading8"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label"
                                for="name">{{ trans('messages.description') }}</label>
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content2"
                                    rows="5" @if ($lang == 'ae') dir="rtl" @endif>{!! $page->getTranslation('content2', $lang) !!}</textarea>
                            </div>
                        </div>

                        <div class="form-group row @if ($lang != 'en') d-none @endif">
                            <label class="col-md-2 col-from-label">{{ trans('messages.industries') }} </label>
                            <div class="col-md-10">
                                <input type="hidden" name="types[]" value="special_industries">
                                <input type="hidden" name="page_type" value="special_industries">
                                <select name="special_industries[]" class="form-control aiz-selectpicker" multiple
                                    data-live-search="true" title="Select Industries"
                                    data-selected="{{ get_setting('special_industries') }}">
                        ...
                        {{-- <h6 class="mb-0">Marine section </h6>
                        <hr>

                        <h6 class="mb-0">Oil & Gas section </h6>
                        <hr>



                        <h6 class="mb-0">HVAC section</h6>
                        <hr>
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">{{ trans('messages.heading') }} <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content4"  rows="5">{!! $page->getTranslation('content4',$lang) !!}</textarea>
                            </div>
                        </div> --}}
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Certifications Section</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" @if ($lang == 'ae') dir="rtl" @endif
                                    class="form-control" placeholder="{{ trans('messages.heading') }}" name="heading5"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label"
                                for="name">{{ trans('messages.description') }}</label>
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content3"
                                    rows="5" @if ($lang == 'ae') dir="rtl" @endif>{!! $page->getTranslation('content3', $lang) !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row @if ($lang != 'en') d-none @endif">
                            <label class="col-md-2 col-form-label" for="gallery_images">
                                {{ trans('messages.certification') . ' ' . trans('messages.images') }}
                            </label>
                            <div class="col-md-10">
                                <div class="input-group" data-toggle="aizuploader" data-multiple="true"
                                    ...
                                    <input type="hidden" name="image1"
                                        class="selected-files" value="{{ old('image1', $page->getTranslation('image1', $lang)) }}">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" @if ($lang == 'ae') dir="rtl" @endif
                                    class="form-control" placeholder="{{ trans('messages.heading') }}" name="heading3"
