                                        ...
                                        <div class="row gutters-5">
                                            <div class="col">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker" name="product_categories[]" data-live-search="true" data-selected={{ $value }}
                                                        required>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">Main {{ trans('messages.heading') }} <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content2" rows="5"  @if($lang == 'ae') dir="rtl" @endif >{!! $page->getTranslation('content2',$lang) !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">{{ trans('messages.description') }}</label>
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content3" rows="5"  @if($lang == 'ae') dir="rtl" @endif >{!! $page->getTranslation('content3',$lang) !!}</textarea>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">Sub {{ trans('messages.heading') }} <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label" for="name">{{ trans('messages.description') }}</label>
                            <div class="col-sm-10">
                                <textarea class="resize-off form-control" placeholder="{{ trans('messages.description') }}" name="content5" rows="10" >{!! $page->getTranslation('content5',$lang) !!}</textarea>
                            </div>
                        </div>
