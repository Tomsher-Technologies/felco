    ...
    <div class="card">
        ...
        <form class="p-4" action="{{ route('custom-pages.update', $page->id) }}" method="POST"
            ...
            <div class="card-body px-0">
                ...
                @php
                    $sections = \App\Models\ServiceSale::where('lang', $lang)->orderBy('sort_order','ASC')->get();
                    
                @endphp
                <div class=" repeater">
                    <div data-repeater-list="sections">
                        
                        @foreach($sections as $faq)
                            <div data-repeater-item>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="section_title" class="form-control"  value="{{ $faq->title }}" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea rows="5" name="section_content" class="form-control">{{ $faq->content }}</textarea>
                                    </div>
                                </div>

                                <div class="form-group row ">
                                    <label class="col-md-2 col-from-label">Image</label>
                                    <div class="col-md-10">
                                        <div class=" input-group " data-toggle="aizuploader" data-type="image">
                                            ...
                                            <input type="hidden" name="image" class="selected-files" value="{{ $faq->image }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-from-label">Sort Order:</label>
                                    <div class="col-sm-10">
                                        <input type="number" rows="5" name="order" class="form-control"  value="{{ $faq->sort_order }}">
                                    </div>
                                </div>
                        ...
                        <div data-repeater-item style="display: none;">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-from-label">Content:</label>
                                <div class="col-sm-10">
                                    <textarea  rows="5" name="section_content" class="form-control"></textarea>
                                </div>
                            </div>
                    ...
                    <button type="button" class="btn btn-primary" data-repeater-create>Add Section</button>
                </div>
            </div>
