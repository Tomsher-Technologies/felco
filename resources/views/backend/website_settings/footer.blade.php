    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row gutters-10">
                        ...
                        <div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter title" name="footer_title"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="footer_description" placeholder="Type.."  rows="5">{!! get_setting('footer_description', null, $lang) !!}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Newsletter Title</label>
                                    <input type="hidden" name="types[][{{ $lang }}]" value="newsletter_title">
                                    <input type="text" class="form-control" placeholder="Enter title" name="newsletter_title"
                                        value="{{ get_setting('newsletter_title', null, $lang) }}">
                                </div>
                ...
                <div class="col-lg-6 mx-auto  @if ($lang != 'en') d-none @endif">
                    <div class="card shadow-none bg-light">
                        <div class="card-header">
