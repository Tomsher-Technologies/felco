...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h1 class="mb-0 h6">Update Manual Section</h5>
    </div>
    <div class="">
        <form class="form form-horizontal mar-top" method="POST" action="{{ route('manual-sections.update', $section->id) }}">
                        ...
                        <div class="card-body  p-0">
                                ...
                                @foreach (\App\Models\Language::all() as $key => $language)
                                    <li class="nav-item">
                                        <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                                            href="{{ route('manual-sections.edit', ['id' => $section->id, 'lang' => $language->code]) }}">
                            ...
                            <div class=" p-4">
                                ...
                                <div class="form-group mb-0 text-right">
                                    ...
                                    <a href="{{ route('manual-sections.all',['id' => $section->manual_id]) }}" class="btn btn-md btn-cancel">{{trans('messages.cancel')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
