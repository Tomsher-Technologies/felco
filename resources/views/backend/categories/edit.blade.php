                ...
                <div class="card-body p-0">
                    ...
                    <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="title 2" id="title2" name="title2"
                                    value="{{ old('title2', $category->getTranslation('title2', $lang)) }}"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea id="home_content" name="home_content" rows="3" class="form-control">{{ old('home_content', $category->getTranslation('home_content', $lang)) }}</textarea>
                            </div>
                        </div>
